...
const app = Vue.createApp({
    ...
    methods: {
        ...
        resetData() {
            if (
                ...
                this.cvData = CVDataStore.deepClone(
        ...
        handleLanguageChange(locale) {
            ...
            this.$forceUpdate();
            for (const child of Object.values(this.$refs)) {
                if (child && typeof child.$forceUpdate === "function") {
                    child.$forceUpdate();
                }
            }
        },
    ...
    created() {
        ...
        this.$on("localeChanged", this.handleLanguageChange);
    },
    beforeDestroy() {
        this.$off("localeChanged", this.handleLanguageChange);
    },
});
