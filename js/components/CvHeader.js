    ...
    <header class="flex flex-col md:flex-row print:flex-row items-center bg-secondary dark:bg-dark-secondary p-5 rounded-lg mb-2 print:mb-4 print:p-2 print:!bg-white mt-16 print:mt-0">
        <div class="flex-shrink-0 mb-5 md:mb-0 print:mb-0 md:mr-5 print:mr-5">
            ...
            <div v-if="editMode" class="relative mt-2">
                <label for="profilePictureInput" class="sr-only">URL de la foto de perfil</label>
                <input id="profilePictureInput" type="text" v-model="cvData.profilePicture" placeholder="URL de tu foto de perfil" class="edit-input pr-7">
        ...
        <div class="flex-1 text-center md:text-left print:text-left space-y-2">
            <h1 class="text-primary dark:text-dark-primary text-2xl md:text-3xl font-bold print:!text-black print:!mb-2">
                ...
                <div v-else class="relative">
                    <label for="nameInput" class="sr-only">Nombre completo</label>
                    <input id="nameInput" type="text" v-model="cvData.name" placeholder="Nombre completo" class="edit-input text-2xl md:text-3xl font-bold pr-8">
                    <i v-if="cvData.name" 
            ...
            <p class="print:!text-black">
                ...
                <template v-else>
                    <span class="relative inline-block">
                        ...
                        <input id="emailInput" type="email" v-model="cvData.email" placeholder="tu.correo@ejemplo.com" class="edit-input inline-block w-auto pr-7">
                ...
                <template v-else>
                    <span class="relative inline-block">
                        <label for="phoneInput" class="sr-only">Número de teléfono</label>
                        <input id="phoneInput" type="tel" v-model="cvData.phone" placeholder="+54 11 12345678" class="edit-input inline-block w-auto pr-7">
            ...
            <p class="print:!text-black">
                ...
                <template v-else>
                    <span class="relative inline-block mr-1">
                        <label for="websiteDisplayInput" class="sr-only">Texto a mostrar para el sitio web</label>
                        <input id="websiteDisplayInput" type="text" v-model="cvData.websiteDisplay" placeholder="Ej: Mi Portafolio" class="edit-input inline-block w-auto pr-7">
                    ...
                    <span class="relative inline-block">
                        <label for="websiteUrlInput" class="sr-only">URL del sitio web</label>
                        <input id="websiteUrlInput" type="url" v-model="cvData.websiteUrl" placeholder="https://www.tusitio.com" class="edit-input inline-block w-auto pr-7">
            ...
            <p class="print:!text-black">
                ...
                <span v-else class="relative block">
                    <label for="addressInput" class="sr-only">Dirección</label>
                    <input id="addressInput" type="text" v-model="cvData.address" placeholder="Calle Número, Ciudad, Provincia" class="edit-input pr-7">
            ...
            <p class="print:!text-black">
                ...
                <span v-if="!editMode">{{ cvData.birthdate }}</span>
                 <span v-else class="relative block">
                    <label for="birthdateInput" class="sr-only">Fecha de nacimiento</label>
                    <input id="birthdateInput" type="text" v-model="cvData.birthdate" placeholder="DD de Mes de AAAA (ej: 18 de enero de 1973)" class="edit-input pr-7">
